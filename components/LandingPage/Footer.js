...
export default function Footer() {
  return (
    <div className='bg-green_color font-proxima-nova footer hover:cursor-pointer px-4 md:px-10 lg:px-20 py-6 md:py-10 text-white flex flex-row justify-between'>
